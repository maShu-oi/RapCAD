...
template <class P>
class CGALBuilder : public CGAL::Modifier_base<typename P::HalfedgeDS>
{
public:
...
template <class P>
CGALBuilder<P>::CGALBuilder(CGALPrimitive* p)
{
	primitive=p;
}

template <class P>
void CGALBuilder<P>::operator()(HalfedgeDS& hds)
{
...
template <class P>
CGALPrimitive* CGALBuilder<P>::triangulate()
{
...
template <class P>
CGALPrimitive* CGALBuilder<P>::buildOffsetPolygons(const CGAL::Scalar amount)
{
...
template <class P>
void CGALBuilder<P>::makeSideZ(const CGAL::Scalar& x1,const CGAL::Scalar& x2,const CGAL::Scalar& y1,const CGAL::Scalar& y2,const CGAL::Scalar& z)
{
...
template <class P>
void CGALBuilder<P>::makeSideY(const CGAL::Scalar& x1,const CGAL::Scalar& x2,const CGAL::Scalar& y,const CGAL::Scalar& z1,const CGAL::Scalar& z2)
{
...
template <class P>
void CGALBuilder<P>::makeSideX(const CGAL::Scalar& x,const CGAL::Scalar& y1,const CGAL::Scalar& y2,const CGAL::Scalar& z1,const CGAL::Scalar& z2)
{
